...
function OportunitieOpeninBadge() {
  return (
    <>
      <p
      className="text-sm inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-dashed border-green-500 font-medium bg-green-300/30 text-green-700"
      >
        {/* Round dot */}
        <div className="border-green-600/70 bg-green-300 rounded-full relative manual-ping">
          <div className="absolute inset-0 rounded-full bg-green-300"></div>
          <div className="size-1.5 bg-green-700 rounded-full relative z-10 m-0.5"></div>
        </div>
