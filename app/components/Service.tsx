...
export function Service() {
  const services = [
    ...
    },
    {
      ...
      description: "Robust API design, third-party integration, and automation.",
      icon: <Server className="h-12 w-12 text-purple-600" />,
      accent: "before:bg-purple-600"
    },
    {
      title: "DevOps & Deployment",
      description: "From CI/CD pipelines to cloud infrastructure, I handle deployment and operations for seamless delivery.",
      icon: <Cloud className="h-12 w-12 text-orange-500" />,
      accent: "before:bg-orange-500"
    },
    {
      title: "End-to-End Delivery",
      description: "I manage the full lifecycle: from development to deployment, ensuring quality and reliability at every step.",
      ...
      <div className="container mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-500 font-medium">
            From <span className="text-primary font-semibold">development</span> to <span className="text-green-600 font-semibold">deployment</span>, I deliver modern solutions for the web.
          </p>
        </motion.div>
        <motion.div
